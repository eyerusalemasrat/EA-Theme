<?php
/**
 * EA-Theme functions and definitions
 *
...
if ( ! function_exists( 'ea_theme_setup' ) ) :
	...
	function ea_theme_setup() {
		 ...
		 * If you're building a theme based on EA-Theme, use a find and replace
		 * to change 'ea-theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'ea-theme', get_template_directory() . '/languages' );
